...
<head>
    <meta charset="utf-8">
    <title>FYN - Member Detail Page</title>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">${memData.memName }'s Details</h6>
                            <form method="post" action="adminMemberUpdate.do?memId=${memData.memId }">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="${memData.memId }" disabled style="background-color:black">
                                <label for="floatingInput">ID</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="${memData.memPassword }" name="memPassword" >
                                <label for="floatingInput">Password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="${memData.memName }" name="memName">
                                <label for="floatingInput">Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="${memData.memEmail }" name="memEmail">
                                <label for="floatingInput">Email address</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="text" value="${memData.memPhone }" name="memPhone">
                                <label for="floatingPassword">Phone Number</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="text" value="${memData.memMoney }" name="memMoney">
                                <label for="floatingPassword">Money</label>
                            </div>
                            <div class="form-floating">
                                <input type="submit" class="btn btn-outline-primary m-2" value="Update">
                                <a href="adminMemberDelete.do?memId=${memData.memId }" class="btn btn-outline-primary m-2">Delete</a>
