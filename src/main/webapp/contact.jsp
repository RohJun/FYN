            ...
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-secondary p-5">
                        ...
                        <h1 class="text-uppercase mb-4">Have Any Questions? Please Contact Us!</h1>
                        <p class="mb-4">Ask us anything! We will be in touch as soon as possible. Thank you for checking our site.</p>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100" style="min-height: 400px;">
                        <img class="google-map w-100 h-100"
                        src="img/smashNft.jpg"
                        ></img>
                    </div>
                </div>
            </div>
